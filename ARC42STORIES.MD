...
| parent#191 — `casehub-connectors.md` deep-dive needs `slack-bot` module row | Docs debt | Low | Module Structure table missing `casehub-connectors-slack-bot`. Filed; not blocking. |
